...
export default function Layout() {
  ...
  const speedDialDialogOpen = useSelector(
    (state) => state.dialogs.speedDialDialogOpen
  );
  ...
  const handleSpeedDialClick = () => {
    console.log("Click Alert: 1 handleSpeedDialClick");
    dispatch(setSpeedDialDialog(!speedDialDialogOpen));
  };
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <div onClick={handleSpeedDialClick}>
        <SpeedDial
