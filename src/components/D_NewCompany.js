...
export default function AddCompanyDialog() {
  ...
  const cPrimaryClient = useSelector(
  ...
  const companyDialogOpen = useSelector(
    (state) => state.dialogs.companyDialogOpen
  );
      ...
      <Dialog
        ...
        <DialogContent>
          ...
          <Box
            ...
            <br />
            <Divider
              style={{ marginBottom: "16px", marginTop: "10px" }}></Divider>
            <TextField
              id="contactDate"
              label="Contact Date"
              type="date"
